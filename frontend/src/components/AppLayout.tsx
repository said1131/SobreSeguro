      ...
      <div className="h-screen bg-gray-900 flex overflow-hidden">
        ...
        {/* Logo */}
          ...
          <nav className="p-6 space-y-4 flex-1">
            ...
            <div className="mt-24 pt-6 border-t border-amber-900/40 flex flex-col items-center relative">
              {showTooltip && (
                <div className="absolute bottom-32 left-1/2 -translate-x-1/2 z-50 w-44 bg-amber-500 text-gray-950 text-xs font-semibold p-3 rounded-xl shadow-2xl border border-amber-400 text-center">
