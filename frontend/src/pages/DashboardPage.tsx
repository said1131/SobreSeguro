        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-700/50 rounded-lg p-4">
              <p className="text-gray-400 text-sm mb-1">Porcentaje Ahorrado</p>
              <div className="flex items-end gap-2">
                <p className="text-3xl font-bold text-amber-400">
                  {totalNeto > 0 ? ((totalAhorrado / totalNeto) * 100).toFixed(1) : 0}%
                </p>
                <p className="text-gray-400 text-sm mb-1">del total</p>
              </div>
            </div>
            <div className="bg-gray-700/50 rounded-lg p-4">
              <p className="text-gray-400 text-sm mb-1">Dinero Disponible</p>
              <div className="flex items-end gap-2">
                <p className="text-3xl font-bold text-emerald-400">
                  ${(totalNeto - totalAhorrado).toLocaleString('es-ES', { maximumFractionDigits: 2 })}
                </p>
              </div>
            </div>
          </div>
